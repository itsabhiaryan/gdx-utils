...
import com.nayragames.vis.component.PhysicsHelperComponent;

import static com.nayragames.vis.physics.PhysicsManager.addPhysicsBody;
...
public class PhysicsFactory {
    ...
    public static Entity createPhysicsShape(World world, int layerId, Color color, Size size, Position point, float angle, BodyDef.BodyType type, float density){
        ...
        EntityManager.addRenderer(entity,0);
        //new PhysicsOrigin());
         addPhysicsBody(entity,type,density,point.x,point.y,size.x,size.y,false,angle);
