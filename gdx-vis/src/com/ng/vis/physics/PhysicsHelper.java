...
import com.ng.vis.GenericEntityBuilder;
...
public class PhysicsHelper {
    ...
    public static MouseJoint createMouseJoint(World world, Body ground, Body hitBody, Vector3 unProjectVec){
        MouseJointDef mouseJointDef= GenericPhysicsHelper.createMouseJointDef(ground,hitBody,unProjectVec);
    ...
    public static Array<Entity> addObject(World world, int type){
        ...
        switch (type){
            ...
            case 0:
                ...
                return PhysicsHelper.createHangingChain(world,new Vector2(61.5f,4.1f),1.2f);

            case 1:
                return PhysicsHelper.createHangingChain(world,new Vector2(10f,4.1f),1.1f);


            case 2:
                return PhysicsHelper.addSecondObject1(world,new Vector2(25,4.4f),new Vector2(27f,4.3f),1.3f);


            case 3:
                // return PhysicsHelper.addSecondObject(world,new Vector2(37,4),new Vector2(39,4),1.5f);
                return  PhysicsHelper.addFirstObject(world,new Vector2(38,4.3f),1.3f);
    ...
    public static Array<Entity> addFirstObject(World world, Vector2 firstPoint,float rope_length){
        ...
        Entity pivot = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(pivot_width, pivot_height), Position.makePosition(firstPoint.x, firstPoint.y), 0, BodyDef.BodyType.StaticBody, 1);
        entities.add(pivot);
        ...
        Entity entity2 = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(hangBlock_width, hangBlock_height), Position.makePosition(firstPoint.x, firstPoint.y), 0, BodyDef.BodyType.DynamicBody, 1);
        ...
        for (int i = 0; i < e_count; i++) {
            ...
            Entity e= PhysicsFactory.createPhysicsShape(world,0 ,Color.BLACK, Size.makeSize(2*rope_width,2*rope_height), Position.makePosition(firstPoint.x,firstPoint.y),0, BodyDef.BodyType.DynamicBody,1);
    ...
    public static Array<Entity> addSecondObject(World world, Vector2 firstPoint,Vector2 secondPoint,float rope_length) {
        ...
        Entity pivotEntity1 = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(pivot_width, pivot_height), Position.makePosition(firstPoint.x, firstPoint.y), 0, BodyDef.BodyType.StaticBody, 1);
        Body pivotBody1 = pivotEntity1.getComponent(PhysicsBody.class).body;

        entities.add(pivotEntity1);

        Entity pivotEntity2 = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(pivot_width, pivot_height), Position.makePosition(secondPoint.x, secondPoint.y), 0, BodyDef.BodyType.StaticBody, 1);
        ...
        Entity entity2 = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(hangBlock_width, hangBlock_height), Position.makePosition(firstPoint.x + dst / 2f, firstPoint.y-rope_length/2), 0, BodyDef.BodyType.DynamicBody, 1);
        Body body2 = entity2.getComponent(PhysicsBody.class).body;
...

        {
            ...
            for (int i = 0; i < e_count; i++) {
                ...
                Entity e= PhysicsFactory.createPhysicsShape(world, 0, Color.BLACK, Size.makeSize(2 * rope_width, 2 * rope_height), Position.makePosition(firstPoint.x+i*rope_width, firstPoint.y), 0, BodyDef.BodyType.DynamicBody, 1);
                entities.add(e);
...

        {
            ...
            for (int i = 0; i < e_count; i++) {
                ...
                Entity e= PhysicsFactory.createPhysicsShape(world, 0, Color.BLACK, Size.makeSize(2 * rope_width, 2 * rope_height), Position.makePosition(secondPoint.x-i*rope_width, secondPoint.y), 0, BodyDef.BodyType.DynamicBody, 1);
                entities.add(e);
    ...
    public static Array<Entity> addSecondObject1(World world, Vector2 firstPoint,Vector2 secondPoint,float rope_length){
        ...
        Entity entity2 = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(dst+hingOffset, hangBlock_height), Position.makePosition(firstPoint.x, firstPoint.y-rope_length), 0, BodyDef.BodyType.DynamicBody, 1);
        Body body2 = entity2.getComponent(PhysicsBody.class).body;
...

        {
            ...
            float e_count = (rope_length - pivot_height/2-hangBlock_height/2) / (2 * rope_width);
            for (int i = 0; i < e_count; i++) {
                Entity e= PhysicsFactory.createPhysicsShape(world, 0, Color.BLACK, Size.makeSize(2 * rope_width, 2 * rope_height), Position.makePosition(secondPoint.x, secondPoint.y), 0, BodyDef.BodyType.DynamicBody, 1);
                entities.add(e);
                Body body=e.getComponent(PhysicsBody.class).body;
    ...
    public static Array<Entity> createBridge(World world,Vector2 firstPoint,Vector2 secondPoint,float length){
        ...
        Entity entity1 = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(pivot_width, pivot_height), Position.makePosition(firstPoint.x, firstPoint.y), 0, BodyDef.BodyType.StaticBody, 1);
        Body pivotBody1 = entity1.getComponent(PhysicsBody.class).body;

        array.add(entity1);

        Entity entity2 = PhysicsFactory.createPhysicsShape(world, 1, Color.BLACK, Size.makeSize(pivot_width,pivot_height), Position.makePosition(secondPoint.x, secondPoint.y), 0, BodyDef.BodyType.StaticBody, 1);
        ...
        for (int i = 0; i < e_count; i++) {
            Entity e= PhysicsFactory.createPhysicsShape(world,0 ,Color.BLACK, Size.makeSize(2*rope_width,2*rope_height), Position.makePosition(point1.x + i*rope_width,point1.y) ,0, BodyDef.BodyType.DynamicBody,1);
            array.add(e);
            Body body=e.getComponent(PhysicsBody.class).body;
...
//			.5f, .25f
            ...
            //.05
            Body body1= PhysicsFactory.createPhysicsShape(world,0, Color.BLACK, Size.makeSize(.05f,.05f), Position.makePosition(point1.x-rope_width,point1.y-rope_width),0, BodyDef.BodyType.StaticBody,0).getComponent(PhysicsBody.class).body;
            Body body2= PhysicsFactory.createPhysicsShape(world,0, Color.BLACK, Size.makeSize(.05f,.05f), Position.makePosition(point2.x-rope_width,point2.y-rope_width),0, BodyDef.BodyType.StaticBody,0).getComponent(PhysicsBody.class).body;
...
//			world.createJoint(jd1);
    ...
    public static void createCircularMotion(World world, int totalObject, int type, float size, float x, float y, float radius,boolean isPhysics ,CircularMotion.MotionType motionType){
        ...
        int layer=1;
        float density=1;
        Shape shape= GenericPhysicsHelper.createShape(size,type);

        for (int i=0;i<totalObject;i++){
            Entity entity1=null;
            if(type== GenericPhysicsHelper.CIRCLE)
                entity1= GenericEntityBuilder.createShape(world,layer,Color.BLACK,size,Position.makePosition(x,y,true),0);
            else if(type== GenericPhysicsHelper.SQUARE)
            ...
            if(isPhysics) PhysicsManager.addPhysicsBody(entity1,shape,density, GenericPhysicsHelper.createBodyDef(BodyDef.BodyType.StaticBody, x, y));
        }
        shape.dispose();
